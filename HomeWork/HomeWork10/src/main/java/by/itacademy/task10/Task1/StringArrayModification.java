package by.itacademy.task10.Task1;
 ...
 *
 *  Необходимо удалить дубликаты из массива предыдущего задания, там где нужно было сделать список и потом удалить буквы “a”.
 */
public class StringArrayModification {
    public static void main(String[] args) {
        ...
        List<String> linesNew = new ArrayList<String>(set);

        System.out.println("Lines without duplicates");
        printLines(linesNew);
